...
public class UserRepository : IUserRepository
{
    ...
    public async Task<User?> GetByTelegramIdAsync(long telegramId)
    {
        ...
        var sql = "SELECT id AS Id, telegram_id AS TelegramId, name AS Name, phone AS Phone, created_at AS CreatedAt FROM users WHERE telegram_id = @TelegramId";
    ...
    {
        await using var connection = new NpgsqlConnection(_connectionString);
        var sql = @"INSERT INTO users (telegram_id, name, phone) VALUES (@TelegramId, @Name, @Phone)
